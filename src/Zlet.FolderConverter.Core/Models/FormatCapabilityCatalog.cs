...
public static class FormatCapabilityCatalog
{
    ...
    private static readonly IReadOnlyDictionary<SourceFormat, FormatCapability> Capabilities =
        new Dictionary<SourceFormat, FormatCapability>
        {
            ...
            [SourceFormat.Docx] = Capability(SourceFormat.Docx, ConversionTarget.Markdown, ConversionTarget.Markdown, ConversionTarget.Copy, ConversionTarget.Skip),
            [SourceFormat.Xlsx] = Capability(SourceFormat.Xlsx, ConversionTarget.Markdown, ConversionTarget.Markdown, ConversionTarget.Copy, ConversionTarget.Csv, ConversionTarget.Tsv, ConversionTarget.Skip),
            [SourceFormat.Pptx] = Capability(SourceFormat.Pptx, ConversionTarget.Markdown, ConversionTarget.Markdown, ConversionTarget.Copy, ConversionTarget.Skip),
            ...
            [SourceFormat.Pdf] = Capability(SourceFormat.Pdf, ConversionTarget.Markdown, ConversionTarget.Markdown, ConversionTarget.Copy, ConversionTarget.Skip),
            ...
            [SourceFormat.Txt] = Capability(SourceFormat.Txt, ConversionTarget.Markdown, ConversionTarget.Markdown, ConversionTarget.Copy, ConversionTarget.Skip),
